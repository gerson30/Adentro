...
document.addEventListener("DOMContentLoaded", function () {
    const lista = document.querySelectorAll(".especialidades-lista li");
    const contenido = document.querySelectorAll(".contenido-item");

    lista.forEach(item => {
        item.addEventListener("click", () => {
            lista.forEach(li => li.classList.remove("activo"));
            contenido.forEach(div => div.classList.remove("activo"));
...
document.addEventListener("DOMContentLoaded", function () {
    const fotos = document.querySelectorAll(".carousel-foto .foto-biografia");
    let current = 0;
